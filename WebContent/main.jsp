...
<script type="text/javascript">
	...
	/* function showContent(content,d){
...
<div region="center">
	<div class="easyui-tabs" fit="true" border="false" id="tabs">
		<div title="首页" data-options="iconCls:'icon-home'">
			<!-- <div id="d" align="center" style="padding-top: 100px"><a href='javascript:showContent('爱大学生/index.html',"d")'><font color="red" size="10">欢迎使用</font></a></div> -->
			
			<iframe src="爱大学生/index.html" width="100%" height="100%" frameborder="0"></iframe>
...
<div region="south" style="height: 25px;padding: 5px" align="center">
	Copyright&copy;&nbsp;2018 etoakor.com.&nbsp;All Rights Reserved.&nbsp;<a href="http://www.miibeian.gov.cn/" target="_blank" id="ft_icp">鲁ICP备16008453号-1</a>
</div>
